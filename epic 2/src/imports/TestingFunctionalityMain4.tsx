import svgPaths from "./svg-rumefiuzwx";
...
function Container4() {
  return (
    <div className="absolute content-stretch flex flex-col h-[568px] items-start left-0 overflow-clip top-[87px] w-[319px]" data-name="Container">
      <Button1 />
      <Button2 />
      <Button3 />
      <Button4 />
...
function SupplierList() {
  return (
    <div className="absolute bg-white border-[rgba(0,0,0,0.1)] border-r-[0.889px] border-solid h-[666px] left-0 top-0 w-[320px]" data-name="SupplierList">
      <Container3 />
      <Container4 />
    </div>
  );
...
function Paragraph1() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-h-px min-w-px not-italic relative text-[#717182] text-[14px]">Grampians Livestock</p>
    </div>
  );
}
...
function Text15() {
  return (
    <div className="h-[20px] relative shrink-0 w-[44.167px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] whitespace-nowrap">18.4 ha</p>
      </div>
    </div>
  );
}
...
function Icon13() {
  return (
    <div className="absolute left-[67.75px] size-[48px] top-0" data-name="Icon">
...
function Paragraph5() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-0 top-[60px] w-[183.5px]" data-name="Paragraph">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#717182] text-[14px] text-center whitespace-nowrap">Showing Grampians Livestock</p>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="absolute content-stretch flex h-[15.986px] items-start left-0 top-[84px] w-[183.5px]" data-name="Paragraph">
...
function Container55() {
  return (
    <div className="h-[99.986px] relative shrink-0 w-[183.5px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon13 />
        <Paragraph5 />
        <Paragraph6 />
...
function Container54() {
  return (
    <div className="absolute content-stretch flex h-[666px] items-center justify-center left-0 px-[239.806px] top-0 w-[663px]" data-name="Container">
      <Container55 />
    </div>
  );
}
...
function Container58() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] whitespace-nowrap">Grampians Livestock</p>
    </div>
  );
}
...
function Container56() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[4px] h-[65.764px] items-start left-[16px] pb-[0.889px] pt-[12.889px] px-[12.889px] rounded-[10px] top-[549.35px] w-[156.125px]" data-name="Container">
...
function MapView() {
  return (
    <div className="absolute bg-[rgba(236,236,240,0.3)] h-[666px] left-[320px] top-0 w-[663px]" data-name="MapView">
      <Container54 />
      <Button7 />
      <Container56 />
    </div>
...
export default function TestingFunctionalityMain() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Testing Functionality_Main4">
      <Header />
      <Container2 />
    </div>
  );
