import svgPaths from "./svg-z9c3vgvztu";
...
function Paragraph1() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-h-px min-w-px not-italic relative text-[#717182] text-[14px]">Alpine Horticulture</p>
    </div>
  );
}
...
function Container30() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] h-[86.889px] items-start left-0 pb-[0.889px] pt-[16px] px-[16px] top-[-24.89px] w-[362.667px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b-[0.889px] border-solid inset-0 pointer-events-none" />
      <Heading2 />
      <Paragraph1 />
    </div>
...
function Paragraph2() {
  return (
    <div className="h-[40px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#717182] text-[14px] top-[-1px] w-[307px]">Medium risk: supplier near biodiversity-sensitive area</p>
    </div>
  );
}
...
function Text13() {
  return (
    <div className="h-[20px] relative shrink-0 w-[19.556px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] whitespace-nowrap">5%</p>
      </div>
    </div>
  );
}
...
function Text15() {
  return (
    <div className="h-[20px] relative shrink-0 w-[41.722px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] whitespace-nowrap">11.5 ha</p>
      </div>
    </div>
  );
}
...
function Text18() {
  return (
    <div className="h-[20px] relative shrink-0 w-[7.514px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] whitespace-nowrap">7</p>
      </div>
    </div>
  );
}
...
function Container31() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[568.833px] items-start left-0 pt-[16px] px-[16px] top-[62px] w-[362.667px]" data-name="Container">
      <Container32 />
      <Container35 />
      <Container40 />
      <Container43 />
...
function RiskProfile() {
  return (
    <div className="absolute bg-white border-[rgba(0,0,0,0.1)] border-l-[0.889px] border-solid h-[631px] left-[983px] overflow-clip top-0 w-[384px]" data-name="RiskProfile">
      <Container30 />
      <Container31 />
    </div>
  );
...
function Icon14() {
  return (
    <div className="absolute left-[62.99px] size-[48px] top-0" data-name="Icon">
...
function Paragraph5() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-0 top-[60px] w-[173.986px]" data-name="Paragraph">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#717182] text-[14px] text-center whitespace-nowrap">Showing Alpine Horticulture</p>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="absolute content-stretch flex h-[15.986px] items-start left-0 top-[84px] w-[173.986px]" data-name="Paragraph">
...
function Container55() {
  return (
    <div className="h-[99.986px] relative shrink-0 w-[173.986px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon14 />
        <Paragraph5 />
        <Paragraph6 />
...
function Container54() {
  return (
    <div className="absolute content-stretch flex h-[631.111px] items-center justify-center left-0 pl-[244.556px] pr-[244.569px] top-0 w-[663.111px]" data-name="Container">
      <Container55 />
    </div>
  );
}
...
function Container58() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] whitespace-nowrap">Alpine Horticulture</p>
    </div>
  );
}
...
function Container56() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[4px] h-[65.764px] items-start left-[16px] pb-[0.889px] pt-[12.889px] px-[12.889px] rounded-[10px] top-[549.35px] w-[147.472px]" data-name="Container">
...
export default function TestingFunctionality() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Testing Functionality">
      <Header />
      <Container2 />
    </div>
  );
