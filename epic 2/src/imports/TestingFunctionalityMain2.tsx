import svgPaths from "./svg-prb4em84hd";
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_4_1323)" id="Icon">
...
function Icon4() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_4_1319)" id="Icon">
...
function Icon5() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_4_1339)" id="Icon">
...
function SupplierList() {
  return (
    <div className="absolute bg-white border-[rgba(0,0,0,0.1)] border-r-[0.889px] border-solid h-[687px] left-0 top-0 w-[320px]" data-name="SupplierList">
      <Container3 />
      <Container4 />
    </div>
  );
...
function Paragraph1() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-h-px min-w-px not-italic relative text-[#717182] text-[14px]">Gippsland Organic Farms</p>
    </div>
  );
}
...
function Container34() {
  return (
    <div className="content-stretch flex h-[15.986px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[16px] min-h-px min-w-px not-italic relative text-[#717182] text-[12px]">Location confidence: medium</p>
    </div>
  );
}
...
function Icon8() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_4_1308)" id="Icon">
...
function Text13() {
  return (
    <div className="h-[20px] relative shrink-0 w-[25.194px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] whitespace-nowrap">15%</p>
      </div>
    </div>
  );
}
...
function Text15() {
  return (
    <div className="h-[20px] relative shrink-0 w-[46.306px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] whitespace-nowrap">34.5 ha</p>
      </div>
    </div>
  );
}
...
function Text18() {
  return (
    <div className="h-[20px] relative shrink-0 w-[7.778px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] whitespace-nowrap">8</p>
      </div>
    </div>
  );
}
...
function Container31() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[615px] items-start left-[0.11px] pt-[16px] px-[16px] top-[87px] w-[363px]" data-name="Container">
      <Container32 />
      <Container35 />
      <Container40 />
      <Container43 />
...
function RiskProfile() {
  return (
    <div className="absolute bg-white border-[rgba(0,0,0,0.1)] border-l-[0.889px] border-solid h-[656px] left-[983px] overflow-clip top-0 w-[384px]" data-name="RiskProfile">
      <Container30 />
      <Container31 />
    </div>
  );
...
function Icon14() {
  return (
    <div className="absolute left-[81.88px] size-[48px] top-0" data-name="Icon">
...
function Paragraph5() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-0 top-[60px] w-[211.75px]" data-name="Paragraph">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#717182] text-[14px] text-center whitespace-nowrap">Showing Gippsland Organic Farms</p>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="absolute content-stretch flex h-[15.986px] items-start left-0 top-[84px] w-[211.75px]" data-name="Paragraph">
...
function Container55() {
  return (
    <div className="h-[99.986px] relative shrink-0 w-[211.75px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon14 />
        <Paragraph5 />
        <Paragraph6 />
...
function Container54() {
  return (
    <div className="absolute content-stretch flex h-[687px] items-center justify-center left-0 px-[225.681px] top-0 w-[663px]" data-name="Container">
      <Container55 />
    </div>
  );
}
...
function Container58() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] whitespace-nowrap">Gippsland Organic Farms</p>
    </div>
  );
}
...
function Container56() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[4px] h-[65.764px] items-start left-[16px] pb-[0.889px] pt-[12.889px] px-[12.889px] rounded-[10px] top-[549.35px] w-[184.653px]" data-name="Container">
...
function MapView() {
  return (
    <div className="absolute bg-[rgba(236,236,240,0.3)] h-[656px] left-[320px] top-0 w-[663px]" data-name="MapView">
      <Container54 />
      <Button7 />
      <Container56 />
    </div>
...
function Container2() {
  return (
    <div className="h-[656px] relative shrink-0 w-[1367px]" data-name="Container">
...
export default function TestingFunctionalityMain() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Testing Functionality_main2">
      <Header />
      <Container2 />
    </div>
  );
